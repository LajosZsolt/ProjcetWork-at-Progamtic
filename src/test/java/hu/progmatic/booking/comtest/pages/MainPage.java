...
public class MainPage {
    ...
    By checkInDateFor27MarchBy = By.cssSelector("span[data-date='2023-03-27']");
    ...
    By checkOutDateFor30MarchBy = By.cssSelector("span[data-date='2023-03-30']");
    ...
    public void addCheckInAndCheckOutDateFor20MarchTo24March() {
        WebElement checkInDateField = driver.findElement(checkInDateFor27MarchBy);
        checkInDateField.click();
        WebElement checkOutDateField = driver.findElement(checkOutDateFor30MarchBy);
        checkOutDateField.click();
        WebElement checkInDateFieldFilled27March = driver.findElement(searchPanelCheckInDateFieldBy);
        Assert.assertEquals(checkInDateFieldFilled27March.getText(), "Mon 27 Mar");
        WebElement checkOutDateFieldFilled30March = driver.findElement(searchPanelCheckOutDateFieldBy);
        Assert.assertEquals(checkOutDateFieldFilled30March.getText(), "Thu 30 Mar");
    ...
    public void clickOnFlightHotelInMenu() throws InterruptedException {
