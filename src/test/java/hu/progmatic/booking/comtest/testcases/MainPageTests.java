...
public class MainPageTests extends DriverBaseTest {
    ...
    @Test(description = "T2: Number of 'Adults' field boundary values", groups = {"smoke", "regression"})
    ...
    @Test(description = "T10: On the main page we check te modification of the numbers of Rooms between -1 and 32", groups = {"smoke", "regression"})
